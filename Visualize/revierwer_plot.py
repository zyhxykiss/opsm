...
if __name__ == "__main__":
    user_change_path = {
        ...
        'reviewer': '../document/reviewer_result/USER_CHANGE/',
    ...
    labels = ["O-PSM", "O-PSM with linear value"]
    ...
    plt.tight_layout()
    plt.savefig("../Visualize_single_fig/reviewer/user_change_value.pdf", bbox_inches='tight', pad_inches=0)
    ...
    plt.title(r"$B=2\times10^4$, $M=641$, $\varepsilon=0.45$")
    plt.tight_layout()
    plt.savefig("../Visualize_single_fig/reviewer/user_change_pay.pdf", bbox_inches='tight', pad_inches=0)
    ...
    plt.tight_layout()
    plt.savefig("../Visualize_single_fig/reviewer/user_change_winner_number.pdf", bbox_inches='tight', pad_inches=0)
