...
if __name__ == "__main__":
    ...
    for user_file in os.listdir(path):
        ...
        users_pi = [pool.apply_async(beacon.payment_stage, (USER, POIs, user, winner, True)) for user in winner["winner"]]
        ...
        storege.storage_all(winner["winner"], POIs, 'document/beacon_result/USER_CHANGE/', int("user_file".split('.')[0]))
